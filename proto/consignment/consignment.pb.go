...
type Container struct {
	Id                   string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	CusomterId           string   `protobuf:"bytes,2,opt,name=cusomter_id,json=cusomterId,proto3" json:"cusomter_id,omitempty"`
...
func (m *Container) GetCusomterId() string {
	if m != nil {
		return m.CusomterId
	}
	return ""
...
var fileDescriptor_e5e5ab05dfa973d5 = []byte{
	...
	0xaf, 0x80, 0xa9, 0xbd, 0xb7, 0xbb, 0x80, 0xae, 0x99, 0x6d, 0xb3, 0x42, 0x47, 0xad, 0x74, 0x13,
	...
	0xe3, 0x6f, 0x65, 0xab, 0x15, 0x02, 0x00, 0x00,
}
